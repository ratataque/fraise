    ...
    def send_verif_mail(self):
        mailField = {  
                        ...
                        {  
                            ...
                            "htmlContent": "<html><head></head><body><h1>Bonjour, veuillez cliquer <a href='http://localhost:3000/verifEmail?uuid="+str(self.uuid)+"'>Ici</a> afin de pouvoir activer votre compte, merci ! </h1></body></html>",
                            "headers":{  
        ...
        requete = requests.post('https://api.sendinblue.com/v3/smtp/email',
                        json=mailField,
                        headers= {
